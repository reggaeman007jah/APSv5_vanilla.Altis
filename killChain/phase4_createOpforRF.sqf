...
Actions:
	...
	create new system that takes positions of opfor generated, and then informs players roughly where they are coming from 
...
execVM "killChain\media\voice\thisIsCommand.sqf";
sleep 2;
execVM "killChain\media\voice\prepare.sqf";
...
[_rndOp1] execVM "killChain\phase5_monitorBluforDefence.sqf"; 