...
/*
ction - check whether this captures any FOB units - we want to leave them at main FOB !!
*/
...
while {RFCHECK} do {
	...
	systemChat "DEBUG - INDI INSURANCE MOVE from phase3Timer.sqf";
	systemChat "check perf!";
	...
	// _units = allUnits inAreaArray "BattleArea";
	{
		...
		// I am removing use of this fnc to save power - needs testing 
		// _endPoint1 = _unitDest getPos [_randomDist,_randomDir];
		_endPoint1 = RGG_patrol_obj getPos [_randomDist,_randomDir];
		sleep 2;
		_x setBehaviour "COMBAT";
