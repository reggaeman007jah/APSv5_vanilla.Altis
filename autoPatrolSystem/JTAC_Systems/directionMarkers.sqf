...
for "_i" from 1 to 20 do { 
	...
	_mk3 setMarkerType "mil_destroy";
	...
	_mk4 setMarkerType "mil_destroy";
	...
	_mk5 setMarkerType "mil_destroy";
	...
	_mk6 setMarkerType "mil_destroy";
